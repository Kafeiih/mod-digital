...
@section('description', 'En este Kit Digital podrás obtener todas las herramientas necesarias para generar productos oficiales del Servicio Local de Educación Pública Andalién Sur. Además, encontrarás logos, iconografías y fuentes aprobadas por las Normas Gráficas del SLEP, para que puedas generar material en tu establecimiento.')
